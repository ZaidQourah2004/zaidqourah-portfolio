...
export default function JournalingApp() {
    const handleDownload = async () => {
        const fileUrl = 'https://raw.githubusercontent.com/ZaidQourah2004/PROJECTS/main/Projects/Python/journal.py';
        const fileName = 'journal.py';
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-r from-gray-900 via-indigo-800 to-gray-800 text-white">
            ...
            <main className="flex-1 flex flex-col items-center justify-start pt-8 p-8 relative">
                ...
                <h1 className="text-5xl font-bold p-4 mt-16">Journaling App</h1>
                <button
                ...
                <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden w-full max-w-5xl p-10">
                    <p className="text-lg mb-6 italic">
                        Welcome to my <strong>Journaling App</strong> project, a Python-based application designed to help you keep track of your daily thoughts and experiences.
                    </p>
                    <h2 className="text-3xl font-semibold mb-4">Key Features:</h2>
                    <ul className="list-disc list-inside mb-6 space-y-2">
                        <li><strong>Easy Entry Management:</strong> Easily add, update, and delete journal entries through a simple command-line interface.</li>
                        <li><strong>Date Tracking:</strong> Automatically associates entries with the date they were created or modified.</li>
                        <li><strong>Search Functionality:</strong> Quickly find past entries by searching for keywords.</li>
                        <li><strong>Persistent Storage:</strong> Entries are saved to a file, ensuring they are retained across sessions.</li>
                    </ul>
